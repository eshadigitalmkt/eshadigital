...
const Footer: React.FC = () => {
  return (
    <footer className="w-full flex flex-col mt-auto font-sans">
      ...
      {/* Top Blue Banner */}
      <div className="bg-[#192747] w-full h-32 md:h-40 relative flex items-center px-8 md:px-16 overflow-hidden">

        {/* Social Icons */}
        <div className="flex gap-8 z-10 text-white">
          <a href="#" className="hover:text-[#fcba00] transition-colors duration-200" aria-label="Facebook">
          ...
          <a href="#" className="hover:text-[#fcba00] transition-colors duration-200" aria-label="LinkedIn">
            <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
            </svg>
          </a>
          <a href="#" className="hover:text-[#fcba00] transition-colors duration-200" aria-label="Instagram">
            <svg className="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div className="bg-[#f6f7fb] w-full px-8 md:px-16 py-8 border-t border-[#192747]/10">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-xs md:text-sm text-[#192747]/70 font-light tracking-wide">
          ...
          <div className="flex items-center gap-3 text-center md:text-right">
            ...
            <span className="text-[#192747]/30">-</span>
